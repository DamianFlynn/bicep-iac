...
resource policyLBMetricAlertDIPAvailability 'Microsoft.Authorization/policyDefinitions@2021-06-01' = {
  name: 'policyLBMetricAlertDIPAvailability'
  properties: {
    displayName: 'Load Ballancer Metric Alert for DIP Availability'
...
resource policyInitiativeLBMetricAlerts 'Microsoft.Authorization/policySetDefinitions@2020-09-01' = {
  name: 'policyInitiativeLBMetricAlerts'
  properties: {
    policyType: 'Custom'
    displayName: 'policy Initiative LB Metric Alerts'
    description: 'policy Initiative LB Metric Alerts'
    metadata: {
      category: 'policyDefCategory'
      source: 'policySource'
      version: '0.1.0'
    ...
    policyDefinitions: [
      {
        policyDefinitionId: policyLBMetricAlertDIPAvailability.id
        parameters: {}
      }
    ]
  }
...
/*
module policyDefinationVDC '../../modules/policy/policy.definition.bicep' = {
  scope: managementGroup('Digi')
  name: 'mg.policy.definations'
  params: {
    mgmtGroupId: 'Digi'
    policies: [
      json(loadTextContent('./policies/Audit virtual machines without disaster recovery configured.json'))
    ]
  }
}

resource policyInitiativeVDC 'Microsoft.Authorization/policySetDefinitions@2020-09-01' = {
  name: 'policyInitiativeVDC'
  properties: {
    policyType: 'Custom'
    displayName: 'policy Initiative VDC'
    description: 'policy Initiative VDC'
    metadata: {
      category: 'policyDefCategory'
      source: 'policySource'
      version: '0.1.0'
    ...
    parameters: {}
    policyDefinitions: policyDefinationVDC.outputs.policyDefinitions
  }
}
*/
